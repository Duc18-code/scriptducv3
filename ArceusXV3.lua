...
Được vận hành bởi admin Nguyen Minh Duc!
...
AZY["e"]["Text"] = [[Welcome to Zeus X | By Nguyen Minh Duc]];
AZY["e"]["Name"] = [[Title]];
...
AZY["1d"]["Image"] = [[rbxassetid://119410653467206]];
...
local function C_9()
	...
	We are writing to welcome you as one of your first beta testers of Zeus X!
	...
	Zeus X an even more effective and user-friendly application.
