...
function RimusLib:MakeNotify(Config)
	...
	spawn(function()
		...
		RimusNotifyGui.Name = "DucNotifyGui"
...
function RimusLib:MakeGui(GuiConfig)
	...
	GuiConfig.NameHub = GuiConfig.NameHub or "Duc Design"
	GuiConfig.NameGam = GuiConfig.NameGam or "V2"
	GuiConfig.Icon = GuiConfig.Icon or "rbxassetid://119410653467206"
